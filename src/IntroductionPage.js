...
function IntroductionPage({setDisplay, username, setSword}) {
    return(
        <div>
            <h1>Introduction</h1>
            ...
            <button onClick={() => setDisplay(<MainPage username={username} setDisplay={setDisplay} setSword={setSword} />)}>Sure</button>
            <button onClick={() => setDisplay(<MainPage username={username} setDisplay={setDisplay}  setSword={setSword} />)}>Heck Yea!</button>
        </div>
    )
}
