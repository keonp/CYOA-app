...
function Sword({setDisplay, username, setSword}) {
    return(
        <div>
            ...
            <button onClick={() => setDisplay(<SwordOption1 username={username} setDisplay={setDisplay} setSword={setSword} />)}>Gleeful</button>
            <button onClick={() => setDisplay(<SwordOption2 username={username} setDisplay={setDisplay} setSword={setSword} />)}>Doc</button>
            <button onClick={() => setDisplay(<SwordOption3 username={username} setDisplay={setDisplay} setSword={setSword} />)}>Smiley</button>
        </div>
    )
}
